...
\begin{frame}{Experiments}
  ...
  \begin{itemize}
    ...
    \item Fully-strong branching \footnote{Bénichou, Michel, et al. "Experiments in mixed-integer linear programming." Mathematical programming 1.1 (1971): 76-94.}: choose the vertex and the order whose resulting LP relaxation has the highest total value.
  \end{itemize}
\end{frame}
...
eco-foodweb-baywet & 128 & 2075 & 86.0* & 32599 & 32599 & 600.02 \\
hamming6-2 & 64 & 1824 & 62.0 & 377 & 221 & 2.06 \\
inf-USAir97.vc & 332 & 2126 & 149.0* & 110982 & 109418 & 600.00 \\
johnson16-2-4 & 120 & 5460 & 105.0 & 181 & 181 & 8.94 \\
johnson8-2-4 & 28 & 210 & 21.0 & 29 & 29 & 0.19 \\
johnson8-4-4 & 70 & 1855 & 65.0 & 441 & 441 & 3.40 \\
keller4 & 171 & 9435 & 156.0 & 12489 & 12489 & 200.11 \\
MANN-a9 & 45 & 918 & 42.0 & 115 & 67 & 0.71 \\
mk11-b2 & 6930 & 20779 & 909.0 & 1 & 1 & 0.90 \\
      \hline
    \end{tabular}
  \end{table}
    \vspace{-0.2cm}
...
\begin{frame}{The Nemhauser-Trotter Theorem}
  ...
  \end{mytheorem}
    Where the partition the set of vertices $S$ into three sets based on $x^*$ are as follows:
        \begin{itemize}
            \item $S_1 = \{v \in V \mid x^*_v > 0.5\}$
            \item $S_0 = \{v \in V \mid x^*_v < 0.5\}$
            \item $S_{1/2} = \{v \in V \mid x^*_v = 0.5\}$
        \end{itemize}
