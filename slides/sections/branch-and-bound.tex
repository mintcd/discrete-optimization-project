...
\begin{frame}{Discussion}
    \begin{figure}
        \centering
        \includegraphics[width=0.75\linewidth]{slides//img/plot.png}
...
\begin{frame}{Discussion}
  \begin{figure}%
    \centering
    \subfloat{{\includegraphics[width=5cm]{slides/img/plot2.png} }}%
    \qquad
    \subfloat{{\includegraphics[width=5cm]{slides/img/plot3.png} }}%
    \caption{Random subplot of mk11-b2, 100 nodes vs 500 nodes.}%
    \label{fig:example}%
\end{figure}
\end{frame}