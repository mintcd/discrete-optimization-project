...
\begin{frame}{General Algorithm}
  ...
  \footnote{The implementation of the algorithm can be seen at \href{https://github.com/mintcd/discrete-optimization-project}{https://github.com/mintcd/discrete-optimization-project}}
\end{frame}
